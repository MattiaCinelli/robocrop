...
def build_model(states, actions):
    model = Sequential()
    # https://stackoverflow.com/questions/66808457/how-can-i-use-a-2d-array-as-input-expected-flatten-input-to-have-3-dimensions
    model.add(Reshape(states, input_shape=(1, 3))) 
